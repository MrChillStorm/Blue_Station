...
_SVGS = {
    ...
    "sound": f'<g {_S}><path d="M4 9.5h3.5L12 5.5v13l-4.5-4H4z"/><path d="M15.5 9.2a4 4 0 0 1 0 5.6M18.3 6.5a7.8 7.8 0 0 1 0 11"/></g>',
    "bell": f'<g {_S}><path d="M6.2 16.5V11a5.8 5.8 0 0 1 11.6 0v5.5l1.7 2H4.5z"/><path d="M10 20.8a2.2 2.2 0 0 0 4 0"/></g>',
